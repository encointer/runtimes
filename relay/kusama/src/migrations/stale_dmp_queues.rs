...
const LOG_TARGET: &str = "runtime::kusama::migrations";

/// Paras with a downward message queue but no head in live state at block 35279280.
const STALE_PARAS: [u32; 8] = [0, 1, 49, 100, 2030, 2034, 2042, 2125];
...
/// does. Skips paras that have a head, since their queue is live.
